...
<body>
		...
		<div class="reg-form fl">
			<form action="" id="register-form" method="post">
				<div class="form-item form-item-account" id="form-item-account">
					<label>用 户 名</label> <input id="form-account" name="regName"
						class="field" autocomplete="off" maxlength="20"
						required="required" placeholder="4-12个字符（英文,下划线,数字）" type="text">
				...
				<div class="form-item" style="z-index: 12;">
					<label>确 认 密 码</label> <input name="pwdRepeat" id="form-equalTopwd"
						class="field" required="required" placeholder="请再次输入密码"
						maxlength="20" type="password"> <img class="i-status"
						src="img/right.png">
					<div class="input-tip">
						<span></span>
					</div>
					<span class="orPhone"> 邮 箱 验证 </span>
				</div>
				...
				<div class="item-phone-wrap">
					<div class="form-item form-item-phone">
						<label class="select-country" id="select-country"
							country_id="0086">手机号</label> <input id="form-phone" name="phone"
							class="field" required="required" placeholder="建议使用常用手机"
							autocomplete="off" maxlength="11" type="text"> <img
							class="i-status" src="img/right.png">
						<div class="input-tip">
							<span></span>
						</div>
	...
	<div id="form-footer" class="footer ">
		<div class="links">
			<a rel="nofollow" target="_blank"> 关于我们</a>| <a rel="nofollow"
				target="_blank">联系我们</a>| <a rel="nofollow" target="_blank">人才招聘</a>|
			<a rel="nofollow" target="_blank">商家入驻</a>| <a rel="no  follow"
				target="_blank">广告服务</a>| <a target="_blank">销售联盟</a>|
		</div>
		<div class="copyright">
			Copyright©2004-2016&nbsp;&nbsp;大田物流&nbsp;版权所有</div>
